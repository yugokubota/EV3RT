...
# =========================================================== スマートキャリーツイン ===========================================================
    ...
    BringObject_to_Gate_Parallel.add_children([
        ...
        IsDistancePassed(name="distance_passed", target_distance=gate_value(400, 700)),
    ...
    smart_carry_puton_first_Parallel.add_children([
        IsDistancePassed(name="distance_passed_ThroughTheGate", target_distance=gate_value(330, 700)),
    ...
    smart_carry_puton_second_Parallel.add_children([
        ...
        RunByGyro(name="Gyro_straight_smart_carry_puton_second", target=-540, power=60,
                pid_p=1.1, pid_i=0.001, pid_d=0.03, target_type=HeadingType.ABSOLUTE),
    ])
