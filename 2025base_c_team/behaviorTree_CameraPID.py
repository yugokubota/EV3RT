...
# =========================================================== スマートキャリーツイン gate back ===========================================================
    ...
    SpinAndRun_Parallel.add_children([
        ...
        RunByGyro(name="run straight_SpinAndRun", target=gate_value(-90,-91), power=80,
                pid_p=1.1, pid_i=0.001, pid_d=0.03, target_type=HeadingType.ABSOLUTE),
    ])
    ...
    Spintotarget_returngate_Parallel.add_children([
        ...
        RunByGyro(name="run straight_SpinAndRun", target=88, power=60,
                pid_p=1.1, pid_i=0.001, pid_d=0.03, target_type=HeadingType.ABSOLUTE),
    ])
    ...
    smart_carry_puton_second_Parallel.add_children([
        IsDistancePassed(name="smart_carry_puton", target_distance=gate_value(900, 600)),
