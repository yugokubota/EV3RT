...
# =========================================================== LAP走行 ===========================================================
    ...
    obstacle_avoid_start_Parallel.add_children([
        IsDistancePassed(name="distance_passed", target_distance=550),
    ...
    obstacle_avoid_end_Parallel.add_children([
        IsDistancePassed(name="distance_passed", target_distance=370),
...
# =========================================================== ダブルループ処理 ===========================================================
    ...
    Doubleloop_start_Parallel.add_children([
        ...
        TraceLineCam(name="traceline_start_doubleloop",power=40, pid_p=1.75, pid_i=0.0012, pid_d=0.18,
    ...
    Bigcircle_Linetrace_InnerEdge_parallel.add_children([
        ...
        TraceLineCam(name="traceline_cam_inner_egde",power=40, pid_p=1.75, pid_i=0.0012, pid_d=0.18,
    ...
    SmallCircleEntryTuning_Parallel.add_children([
        ...
        TraceLineCam(name="traceline_entry_smallcircle",power=40, pid_p=1.75, pid_i=0.0012, pid_d=0.18,
    ...
    SmallCircle_Linetrace_InnerEdge_parallel.add_children([
        DetectBlue(name="detect_blue"),
        IsDistancePassed(name="distance_passed", target_distance=1400),      #青検知しなかったとき用の距離制御
        TraceLineCam(name="traceline_cam_inner_egde",power=40, pid_p=2.0, pid_i=0.0012, pid_d=0.1,
    ...
    BigCircleEntryTuning_Parallel.add_children([
        IsDistancePassed(name="distance_passed", target_distance=1100),
        TraceLineCam(name="traceline_entry_bigcircle",power=40, pid_p=2.0, pid_i=0.0012, pid_d=0.1,
        gs_min=0, gs_max=80,trace_side=TraceSide.OPPOSITE),
    ])
    ...
    BigCircle_Linetrace_CenterEdge_parallel.add_children([
        DetectBlue(name="detect_blue"),
        TraceLineCam(name="BigCircle_Linetrace_CenterEdge",power=40, pid_p=1.75, pid_i=0.0012, pid_d=0.1,
    ...
    Escape_double_loop_Parallel.add_children([
        IsDistancePassed(name="distance_passed", target_distance=800),
        TraceLineCam(name="traceline_cam_center_egde",power=40, pid_p=1.75, pid_i=0.0012, pid_d=0.18,
        gs_min=0, gs_max=80,trace_side=TraceSide.NORMAL),
    ])
...
# =========================================================== スマートキャリーツイン ===========================================================
    ...
    BringObject_to_Gate_Parallel.add_children([
        ...
        IsDistancePassed(name="distance_passed", target_distance=gate_value(400, 800)),
    ...
    SpinAndRun_Parallel.add_children([
        ...
        RunByGyro(name="run straight_SpinAndRun", target=gate_value(94,94), power=80,
                pid_p=1.1, pid_i=0.001, pid_d=0.03, target_type=HeadingType.ABSOLUTE),
    ])
    ...
    smart_carry_puton_first_Parallel.add_children([
        IsDistancePassed(name="distance_passed_ThroughTheGate", target_distance=gate_value(400, 600)),
        RunByGyro(name="run straight_smart_carry_puton", target=gate_value(0, 5), power=75,
                pid_p=1.1, pid_i=0.001, pid_d=0.03, target_type=HeadingType.ABSOLUTE),
    ])
    ...
    # --- 2本目のボトルをつかむ ---
    # [Purpose] ライントレースをすることで決め打ちをリセット
    # [Exit]    距離500 or 赤線検知
    # [Control] Parallel(SuccessOnOne)
    ...
    Spintotarget_360degree_Parallel.add_children([
        IsDistancePassed(name="distance_passed_ThroughTheGate", target_distance=gate_value(1250, 900)),
    ...
    Spintotarget_returngate_Parallel.add_children([
        IsDistancePassed(name="distance_passed_ThroughTheGate", target_distance=gate_value(1700, 1650)),
        RunByGyro(name="run straight_SpinAndRun", target=gate_value(-448,-446), power=60,
                pid_p=1.1, pid_i=0.001, pid_d=0.03, target_type=HeadingType.ABSOLUTE),
    ])
    ...
    smart_carry_puton_second_Parallel.add_children([
        IsDistancePassed(name="smart_carry_puton", target_distance=gate_value(950, 620)),
        RunByGyro(name="Gyro_straight_smart_carry_puton_second", target=gate_value(-540, -538), power=60,
                pid_p=1.1, pid_i=0.001, pid_d=0.03, target_type=HeadingType.ABSOLUTE),
    ])
    ...
    DiagonalRun_Parallel.add_children([
        ...
        RunByGyro(name="DiagonalRun_by_Gyro", target=-45, power=60,
                pid_p=1.1, pid_i=0.001, pid_d=0.03, target_type=HeadingType.ABSOLUTE),
    ])
    ...
    Go_to_blackline_Parallel.add_children([
        ...
        RunByGyro(name="DiagonalRun_by_Gyro", target=-90, power=40,
                pid_p=1.1, pid_i=0.001, pid_d=0.03, target_type=HeadingType.ABSOLUTE),
    ])
    ...
    traceline_cam_DetectBlue_GOAL_Parallel.add_children([
        DetectBlue(name="detect_blue"),
        IsDistancePassed(name="distance_passed_GoBlackLine", target_distance=650),
...
# =========================================================== loop_03 Start ===========================================================
    ...
    # ========= スマートキャリーツイン ========     
        ...
        # --- メインのラインまで垂直に走る
        SpinAround(name="spin by 90 degrees_After_puton_back_first",
                    target=-450,max_power=50,min_power=MIN_POWER,
                    pid_p=1.1,pid_i=0.001,pid_d=0.03,target_type=HeadingType.ABSOLUTE),
        Go_to_blackline_Parallel,
        SpinAround(name="spin by 90 degrees_DetectBlackLine",
                    target=-540, max_power=50, min_power=MIN_POWER,
                    pid_p=1.1, pid_i=0.001, pid_d=0.03,target_type=HeadingType.ABSOLUTE),
        # --- ゴールに向かう
