...
# =========================================================== LAP走行 ===========================================================
    ...
    traceline_cam_start_doubleloop_Parallel.add_children([
        ...
        IsDistancePassed(name="distance_passed", target_distance=500),
        TraceLineCam(name="traceline_cam_lapfinish",power=40, pid_p=1.40, pid_i=0.0012, pid_d=0.18,
...
# =========================================================== ダブルループ処理 ===========================================================
    ...
    Doubleloop_start_Parallel.add_children([
        ...
        TraceLineCam(name="traceline_start_doubleloop",power=48, pid_p=1.4, pid_i=0.0012, pid_d=0.18,
    ...
    Bigcircle_Linetrace_InnerEdge_parallel.add_children([
        ...
        TraceLineCam(name="traceline_cam_inner_egde",power=48, pid_p=1.4, pid_i=0.0012, pid_d=0.18,
    ...
    SmallCircleEntryTuning_Parallel.add_children([
        ...
        TraceLineCam(name="traceline_entry_smallcircle",power=48, pid_p=1.4, pid_i=0.0012, pid_d=0.18,
    ...
    SmallCircle_Linetrace_InnerEdge_parallel.add_children([
        ...
        TraceLineCam(name="traceline_cam_inner_egde",power=43, pid_p=1.4, pid_i=0.0012, pid_d=0.1,
    ...
    BigCircleEntryTuning_Parallel.add_children([
        ...
        TraceLineCam(name="traceline_entry_bigcircle",power=42, pid_p=1.4, pid_i=0.0012, pid_d=0.1,
        gs_min=0, gs_max=80,trace_side=TraceSide.OPPOSITE),
    ])
    ...
    BigCircle_Linetrace_CenterEdge_parallel.add_children([
        DetectBlue(name="detect_blue"),
        TraceLineCam(name="BigCircle_Linetrace_CenterEdge",power=42, pid_p=1.4, pid_i=0.0012, pid_d=0.1,
    ...
    Escape_double_loop_Parallel.add_children([
        IsDistancePassed(name="distance_passed", target_distance=800),
        TraceLineCam(name="traceline_cam_center_egde",power=48, pid_p=1.4, pid_i=0.0012, pid_d=0.18,
        gs_min=0, gs_max=80,trace_side=TraceSide.NORMAL),
    ])
...
# =========================================================== スマートキャリーツイン ===========================================================
    ...
    smart_carry_puton_first_Parallel.add_children([
        IsDistancePassed(name="distance_passed_ThroughTheGate", target_distance=gate_value(450, 600)),
