...
def build_behaviour_tree() -> BehaviourTree:
    ...
    traceline_cam_for_obstacle = TraceLineCam(
        ...
        power=80, pid_p=0.8, pid_i=0.002, pid_d=0.3,
        gs_min=0, gs_max=40,
    ...
    traceline_cam_lapfinish_Parallel.add_children([
        ...
        dynamic_pid_by_distance=[
            {"start": 0, "end": 2600, "power": 55, "p": 2.2, "i": 0.0012, "d": 0.18},
            {"start": 2600, "end": 4800, "power": 80, "p": 0.8,  "i": 0.003,  "d": 0.3},
            {"start": 4800, "end": 9999, "power": 55, "p": 2.2, "i": 0.0012, "d": 0.18}
        ]
        ),
    ])
