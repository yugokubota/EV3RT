...
# =========================================================== スマートキャリーツイン ===========================================================
    ...
    BringObject_to_Gate_Parallel.add_children([
        ...
        IsDistancePassed(name="distance_passed", target_distance=gate_value(450, 800)),
    ...
    Spintotarget_360degree_Parallel.add_children([
        IsDistancePassed(name="distance_passed_ThroughTheGate", target_distance=1100),
    ...
    smart_carry_puton_second_Parallel.add_children([
        IsDistancePassed(name="smart_carry_puton", target_distance=750),
