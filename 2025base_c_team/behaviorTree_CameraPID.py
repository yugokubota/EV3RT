...
def build_behaviour_tree() -> BehaviourTree:
    ...
    BringObject_to_Gate_Parallel.add_children([
        ...
        RunByGyro(name="run straight_BringObject_to_Gate", target=0, power=55,
    ...
    SpinAndRun_Parallel.add_children([
        ...
        RunByGyro(name="run straight_SpinAndRun", target=-90, power=55,
                pid_p=1.1, pid_i=0.001, pid_d=0.03, target_type=HeadingType.ABSOLUTE),
        # RunByGyro(name="run straight_SpinAndRun", target=90, power=55,
        #         pid_p=1.1, pid_i=0.001, pid_d=0.03, target_type=HeadingType.ABSOLUTE),
    ])
    ...
    smart_carry_puton_first_Parallel.add_children([
        ...
        RunByGyro(name="run straight_smart_carry_puton", target=-135, power=55,
                pid_p=1.1, pid_i=0.001, pid_d=0.03, target_type=HeadingType.ABSOLUTE),
        # RunByGyro(name="run straight_smart_carry_puton", target=180, power=55,
        #         pid_p=1.1, pid_i=0.001, pid_d=0.03, target_type=HeadingType.ABSOLUTE),
    ])
    # --------ジャイロでバック（距離で制御）
    ...
    After_puton_back_first_Parallel.add_children([
        ...
        RunByGyro(name="run_back_After_puton_back_first", target=-135, power=-55,
                pid_p=1.1, pid_i=0.001, pid_d=0.03, target_type=HeadingType.ABSOLUTE),
        # RunByGyro(name="run_back_After_puton_back_first", target=180, power=-55,
        #         pid_p=1.1, pid_i=0.001, pid_d=0.03, target_type=HeadingType.ABSOLUTE),
    ])
    ...
    smart_carry_puton_second_Parallel.add_children([
        ...
        RunByGyro(name="run straight_smart_carry_puton_second", target=-270, power=55,
                pid_p=1.1, pid_i=0.001, pid_d=0.03, target_type=HeadingType.ABSOLUTE),
    ])
    # --------ジャイロでバック（距離で制御）
    ...
    After_puton_back_second_Parallel.add_children([
        ...
        RunByGyro(name="run_back_After_puton_back_second", target=-270, power=-55,
                pid_p=1.1, pid_i=0.001, pid_d=0.03, target_type=HeadingType.ABSOLUTE),
    ])
    # --------ジャイロで黒線に向かう処理
    ...
    GoBlackLine_Parallel.add_children([
        ...
        RunByGyro(name="run_back_GoBlackLine", target=-180, power=55,
                pid_p=1.1, pid_i=0.001, pid_d=0.03, target_type=HeadingType.ABSOLUTE),
    ])
    ...
    GoBlackLine2_Parallel.add_children([
        ...
        RunByGyro(name="run_back_GoBlackLine_2", target=-300, power=55,
                pid_p=1.1, pid_i=0.001, pid_d=0.03, target_type=HeadingType.ABSOLUTE),
    ])
    ...
    DetectBlackLine_Parallel.add_children([
        ...
        RunByGyro(name="run_back_DetectBlackLine", target=-270, power=55,
                pid_p=1.1, pid_i=0.001, pid_d=0.03, target_type=HeadingType.ABSOLUTE),
    ])
    ...
    SpinAndRun_Sequence.add_children([
        ...
        SpinAround(name="spin by 45or90 degrees_SpinAndRun_2", target=gate_value(-135, -90), max_power=60, min_power=MIN_POWER,
                    pid_p=1.1, pid_i=0.001, pid_d=0.03, target_type=HeadingType.ABSOLUTE),
    ...
    loop_02.add_children([
        ...
        SpinAround(name="spin by 90 degrees_After_puton_back_second", target=-90, max_power=60, min_power=MIN_POWER,
                    pid_p=1.1, pid_i=0.001, pid_d=0.03, target_type=HeadingType.ABSOLUTE),
        # SpinAround(name="spin by 90 degrees", target=90, max_power=45, min_power=MIN_POWER,
        #             pid_p=1.1, pid_i=0.001, pid_d=0.03, target_type=HeadingType.ABSOLUTE),
        GoBlackLine_Parallel,#--------------------90度回転して一定距離ジャイロで進む
        SpinAround(name="spin by 90 degrees_GoBlackLine_1", target=-45, max_power=60, min_power=MIN_POWER,
                    pid_p=1.1, pid_i=0.001, pid_d=0.03, target_type=HeadingType.ABSOLUTE),
        ...
        SpinAround(name="spin by 90 degrees_DetectBlackLine", target=-90, max_power=60, min_power=MIN_POWER,
                    pid_p=1.1, pid_i=0.001, pid_d=0.03, target_type=HeadingType.ABSOLUTE),
        # SpinAround(name="spin by 90 degrees", target=90, max_power=45, min_power=MIN_POWER,
        #             pid_p=1.1, pid_i=0.001, pid_d=0.03, target_type=HeadingType.ABSOLUTE),
        # --------青線検知するまでライントレース
