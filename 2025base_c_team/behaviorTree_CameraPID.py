...
# =========================================================== ダブルループ処理 ===========================================================
    ...
    SmallCircle_Linetrace_InnerEdge_parallel.add_children([
        DetectBlue(name="detect_blue"),
        IsDistancePassed(name="distance_passed", target_distance=1900),      #青検知しなかったとき用の距離制御
...
# =========================================================== スマートキャリーツイン ===========================================================
    ...
    smart_carry_puton_second_Parallel.add_children([
        IsDistancePassed(name="smart_carry_puton", target_distance=gate_value(1000, 700)),
