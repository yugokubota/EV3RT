...
def build_behaviour_tree() -> BehaviourTree:
    ...
    traceline_cam_lapfinish_Parallel.add_children([
        ...
        TraceLineCam(name="traceline_cam_lapfinish",power=50, pid_p=1.4, pid_i=0.001, pid_d=0.12,
        gs_min=0, gs_max=60,trace_side=TraceSide.CENTER),
    ])
    # ================ ダブルループ処理 ================
    ...
    double_loop_black_selector_2.add_children([
        DetectBlack_2,
        RunAsInstructed(name="go_straight_2", pwm_l=45, pwm_r=45),
    ])
    ...
    double_loop_black_selector_3.add_children([
        DetectBlack_3,
        RunAsInstructed(name="go_straight_3", pwm_l=45, pwm_r=50),
    ])
