...
# =========================================================== LAP走行 ===========================================================
    ...
    obstacle_avoid_middle_Parallel.add_children([
        ...
        RunByGyro(name="object_avoid_gyro", target=5, power=100,
                pid_p=1.1, pid_i=0.001, pid_d=0.03, target_type=HeadingType.ABSOLUTE),
    ])
    ...
    gyro_mukoujoumen_Parallel.add_children([
        IsDistancePassed(name="distance_passed", target_distance=2800),
        RunByGyro(name="gyro_mukoujoumen", target=-84, power=100,
                pid_p=1.1, pid_i=0.001, pid_d=0.03, target_type=HeadingType.ABSOLUTE),
    ])
