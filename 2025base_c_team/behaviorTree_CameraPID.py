...
def build_behaviour_tree() -> BehaviourTree:
    ...
    double_loop_blue_parallel_1.add_children([
        DetectBlue(name="detect_blue"),
        IsDistancePassed(name="distance_passed", target_distance=400),      #青検知しなかったとき用
        TraceLineCam(name="traceline_cam_lapfinish",power=40, pid_p=1.75, pid_i=0.0012, pid_d=0.18,
        gs_min=0, gs_max=80,trace_side=TraceSide.NORMAL),
    ])
    ...
    loop_01.add_children([
        ...
        # --------ここからダブルループ--------
        SpinAround(name="spin by 90 degrees_After_puton_back_first", target=-190, max_power=60, min_power=MIN_POWER,
                    pid_p=1.1, pid_i=0.001, pid_d=0.03, target_type=HeadingType.ABSOLUTE),
